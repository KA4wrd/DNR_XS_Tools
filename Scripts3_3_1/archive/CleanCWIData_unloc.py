...
'''
This script cleans up and reformats unlocated well stratigraphy, construction, static water level, and drop pipe CWI data for entry into tools
such as Create Conspy and Create 2D points.
'''
...
swl_table = arcpy.GetParameterAsText(5)  #gdb table with static water level info.
swl_x_field = arcpy.GetParameterAsText(6) #UTM x coordinate field in swl table
swl_y_field = arcpy.GetParameterAsText(7) #UTM y coordinates field in swl table
strat_table = arcpy.GetParameterAsText(8) #gdb table with strat/lith info
...
cons_cwi_clean = os.path.join(workspace, "cons_unloc_cwi_clean")
...
cons_cwi_TableSelect_5_ = arcpy.management.CalculateFields(cons_cwi_TableSelect_3_,"PYTHON3",[["elev_top", "!dem! - !from_depth!", ""], ["elev_bot", "!dem! - !to_depth!", ""]])[0]
...
dpl_cwi_pt = os.path.join(workspace, "dpl_unloc_cwi")
...
dpl_copy_1 = arcpy.management.DeleteField(dpl_cwi_pt, ["drill_meth", "drill_flud", "hydrofrac", "hffrom", "hfto", "case_mat", "case_joint",
                                                     ...
                                                     "objectid", "Join_Count", "TARGET_FID", "JOIN_FID", "RELATEID_1", "UNIQUE_NO", "WELLNAME", "TOWNSHIP",
                                                     "RANGE", "RANGE_DIR",
                                                     "SECTION", "SUBSECTION", "MGSQUAD_C", "ELEV_MC", "STATUS_C", "USE_C",
                                                     "LOC_MC", "LOC_SRC", "DATA_SRC", "DEPTH_DRLL", "DEPTH_COMP", "DATE_DRLL",
                                                     "CASE_DIAM", "CASE_DEPTH", "GROUT", "POLLUT_DST", "POLLUT_DIR", "POLLUT_TYP",
...
swl_cwi_pt = os.path.join(workspace, "swl_unloc_cwi_pts")
...
swl_copy_1 = arcpy.management.DeleteField(swl_cwi_pt, ["OBJECTID", "Join_Count", "TARGET_FID", "JOIN_FID", "RELATEID_1", "UNIQUE_NO", "WELLNAME", "TOWNSHIP",
                                                     "RANGE", "RANGE_DIR",
                                                     "SECTION", "SUBSECTION", "MGSQUAD_C", "ELEV_MC", "STATUS_C", "USE_C",
                                                     "LOC_MC", "LOC_SRC", "DATA_SRC", "DEPTH_DRLL", "DEPTH_COMP", "DATE_DRLL",
                                                     "CASE_DIAM", "CASE_DEPTH", "GROUT", "POLLUT_DST", "POLLUT_DIR", "POLLUT_TYP",
...
strat_copy = os.path.join(workspace, "strat_unloc_clean")
arcpy.management.Copy(strat_table, strat_copy)

#Delete extra Fields
printit("Deleting extra fields from strat table copy.")
strat_copy_1 = arcpy.management.DeleteField(strat_copy, ["OBJECTID", "Join_Count", "TARGET_FID", "JOIN_FID",
                                                        "RELATEID_1", "UNIQUE_NO", "WELLNAME", "TOWNSHIP", "RANGE", "RANGE_DIR",
                                                        "SECTION", "SUBSECTION", "MGSQUAD_C", "ELEV_MC", "STATUS_C", "USE_C",
                                                        "LOC_MC", "LOC_SRC", "DATA_SRC", "DEPTH_DRLL", "DEPTH_COMP", "DATE_DRLL",
                                                        "CASE_DIAM", "CASE_DEPTH", "GROUT", "POLLUT_DST", "POLLUT_DIR", "POLLUT_TYP",
...
strat_cwi_TableSelect_4_ = arcpy.management.AddFields(strat_copy_1,[["elev_top", "FLOAT", "", "", "", ""], ["elev_bot", "FLOAT", "", "", "", ""]])[0]
...
#%% 7 Delete temporary files/fields
