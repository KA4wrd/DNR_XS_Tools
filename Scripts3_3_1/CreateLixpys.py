...
# Create Lixpys Diagrams
# For use with DNR Cross Section Tools3_3.atbx
# Verified location wells only

# Modified by Kelsey Forward, Minnesota DNR
# Date last modified: 9/23/24

# Create Well Stick Diagrams (Bedrock Geology)
...
arcpy.management.CreateFeatureclass(workspace, "xsln_temp", "POLYLINE", '', 'DISABLED', 'DISABLED')
...
fields_not_to_join = ['OBJECTID','Join_Count','TARGET_FID', 'JOIN_FID', 'c5st_seq_no', 'relateid', 'depth_top',
                      ...
                      'last_strat', 'ohtopunit', 'ohtopelev', 'ohbotunit', 'ohbotelev', 'botholelev',
                      'Join_Count_1', 'TARGET_FID_1', 'et_id', 'utmn', 'utme_min', 'utme_max', 'mn_et_id',
                      'ORIG_FID', 'strat_orig', 'GlobalID']
...
printit("Copying lixpys_2d_poly.")
polygon_file_copy = os.path.join(workspace, "lixpy_2d_poly_prj")
