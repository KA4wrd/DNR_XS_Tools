...
# Create 2D Pump Level points (Traditional display, verified location wells only)
...
arcpy.management.CreateFeatureclass(workspace, "dpl_2d_xsecview", "POINT", '',
                                    'DISABLED', 'DISABLED')

#set point shapefile filepath variable
pointfile = os.path.join(workspace, "dpl_2d_xsecview")
...
pointfile_copy = os.path.join(workspace, "dpl_2d_xsecview_prj")
